...
$query = "SELECT * FROM tbl_matrix_findings";
...
<head>
  ...
  <title>Matrix for Medical Clearance with Findings</title>
...
<body>
  ...
  <!-- Modal -->
  <div class="modal fade" id="findingsaddmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="matrix_findings_code.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="file" name="signature" class="form-control" accept="image/*" style="padding-bottom: 35px;" />
            </div>

            <div class="form-group">
              <label>M.D. Signature</label>
              <input type="file" name="md_signature" class="form-control" accept="image/*" style="padding-bottom: 35px;" />
            </div>
  ...
  <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="matrix_findings_code.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Signature</label>
              <input type="file" name="signature" id="signature"  class="form-control" accept="image/*" style="padding-bottom: 35px;" />
              <label id="signatureLabel"></label>
            </div>
            
            <div class="form-group">
              <label>M.D. Signature</label>
              <input type="file" name="md_signature" id="md_signature" class="form-control" accept="image/*" style="padding-bottom: 35px;" />
              <label id="mdSignatureLabel"></label>
            </div>
      ...
      <!div class="jumbotron">
        <div class="card" style="border-top: 0.2rem solid #dc3545 !important;">
          <h4 class="ml-3 pt-2 text-uppercase" style="color: #dc3545;">
            Matrix for Medical Clearance with Findings
            <button type="button" class="btn btn-primary btn-sm float-right mr-3" data-toggle="modal" data-target="#findingsaddmodal">
              ADD DATA
            </button>  
          </h4>                
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="mb-5 text-center">Month-Year: <?php echo $month; ?> <?php echo $year; ?></h5>
            ...
            <table id="datatableid" class="table table-striped table-bordered table-sm">
              <thead class="table-dark">
                <tr>
                  ...
                  <th scope="col">M.D. Signature</th> <!--data 10-->
                  <th scope="col">Remarks</th> <!--data 11, dating 10-->
              ...
              ?>
                  <tbody>
                    <tr>
                      ...
                      <td><img src="<?php echo $row['signature']; ?>" alt="Signature" style="max-width: 100px; max-height: 100px;"></td>
                      <td><img src="<?php echo $row['md_signature']; ?>" alt="M.D. Signature" style="max-width: 100px; max-height: 100px;"></td>
              ...
              <tfoot>
                <tr>
                  <th colspan="13">Prepared By: <?php echo $prepared_by; ?> | Noted By: <?php echo $noted_by; ?></th>
                </tr>
              </tfoot>
            </table>
          </div>
    ...
    $(document).ready(function () {
      ...
      $('#csv_file_input').change(function () {
        ...
        if (file) {
          ...
          $.ajax({
            url: 'matrix_findings_code.php', // Specify the path to your import script
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
  ...
  <script>
    $(document).ready(function () {
      $('.editbtn').on('click', function () {
        ...
        $('#sc').val(data[5]);
        $('#pwd').val(data[6]);
        $('#date_of_request').val(data[7]);
        $('#date_acted_upon').val(data[8]);
        
        $('#signatureLabel').text(data[9]);
        $('#mdSignatureLabel').text(data[10]);

        $('#signatureFileName').val(data[9]);
        $('#mdSignatureFileName').val(data[10]);
        $('#remarks').val(data[11]);
      });
    });
  </script>
