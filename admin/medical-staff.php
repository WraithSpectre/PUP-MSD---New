	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="active" href="medical-staff.php">Medical Staff</a>
						</li>
					</ul>
				</div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Add Medical Staff</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="add_medical_staff_process.php">
                                ...
                                <p>Re-Enter Your Password: <input type="password" name="cpass" required></p>
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						<h3>PUPMSD Medical Staff</h3>
						<i class='bx bx-search' ></i>
						<i class='bx bx-filter' ></i>
					</div>
					<?php 
                    $sql = "SELECT * FROM medical_staff WHERE specialization IN ('Doctor', 'Nurse')";
							...
							if ($result->num_rows > 0) {
								while ($row = $result->fetch_assoc()) {
									echo "<tr>
											...
											<td>
                                                <button data-id='" . $row['user_id'] . "' class='archiveStaff btn btn-warning'>Archive</button>
											</td>
										</tr>";
								}
							} else {
