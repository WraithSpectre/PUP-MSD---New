...
// insert a new user
$stmt = $mysqli->prepare("INSERT INTO admin (admin_id, first_name, last_name, email, pass, account_status) VALUES (null, ?, ?, ?, ?, ?)");
$stmt->bind_param('sssss', $first_name, $last_name, $email, $hashed_password, $account_status);
